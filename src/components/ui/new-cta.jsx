...
//             <Zap className="h-4 w-4 text-primary-300 mr-2" />
...
//               whileTap={{ scale: 0.98 }}
//               className="w-full sm:w-auto px-8 py-4 bg-white text-primary-900 rounded-xl hover:bg-primary-50 transition-colors flex items-center justify-center group font-semibold"
//             >
//               Start Free Trial
...
//               whileHover={{ scale: 1.02 }}
//               whileTap={{ scale: 0.98 }}
//               className="w-full sm:w-auto px-8 py-4 border-2 border-white/20 text-white rounded-xl hover:bg-white/10 transition-colors"
//             >
//               View Documentation
//             </motion.button>
//           </div>
