...
const features = [
  {
    ...
    description:
      'Our GST  verification process follows strict security measures, ensuring compliance with government regulations and data protection standards.',
  },
  {
    badge: <SendIcon className="w-4 h-4" />,
    title: 'Instant  Authentication',
    description:
      'Verify GST transactions quickly and securely with real-time  authentication sent to your registered mobile or email.',
  },
  {
...
const otherProducts = [
  {
    ...
    description: 'Verify GST details using -based authentication.',
