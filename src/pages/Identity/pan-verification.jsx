...
const features = [
  {
    ...
    description: 'Quick and reliable PAN verification with instant results.',
  },
  {
    badge: <ShieldCheckIcon className="w-4 h-4" />,
    title: 'Secure and Compliant',
    description: 'Ensuring data security with compliance to regulations.',
  },
  {
    badge: <ClockIcon className="w-4 h-4" />,
    title: '24/7 Availability',
    description: 'Verify PAN details anytime, anywhere.',
  },
]
