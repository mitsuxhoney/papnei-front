...
const features = [
  {
    badge: <LinkIcon className="w-4 h-4" />,
    title: 'Seamless Aadhaar Linking',
    description: 'Effortlessly link Aadhaar and PAN for identity verification.',
  },
  {
    badge: <ShieldCheckIcon className="w-4 h-4" />,
    title: 'Government Compliant',
    description: 'Meets the latest compliance requirements for linking.',
  },
  {
    badge: <CheckIcon className="w-4 h-4" />,
    title: 'Accurate Validation',
    description: 'Ensures Aadhaar and PAN details match precisely.',
  },
]
