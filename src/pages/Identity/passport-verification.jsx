...
const features = [
  {
    ...
    description: 'Verify passport details for authentication.',
  },
  {
    badge: <ShieldCheckIcon className="w-4 h-4" />,
    title: 'Comprehensive Security',
    description: 'Ensures verification meets global standards.',
  },
  {
    badge: <CheckIcon className="w-4 h-4" />,
    title: 'Accurate Data Extraction',
    description: 'Fetch valid passport details with precision.',
  },
]
