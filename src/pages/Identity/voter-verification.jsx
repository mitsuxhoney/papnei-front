...
const features = [
  {
    badge: <UserCheck className="w-4 h-4" />,
    title: 'Secure Voter Verification',
    description: 'Authenticate voter details with confidence.',
  },
  {
    badge: <BarChartIcon className="w-4 h-4" />,
    title: 'Real-time Checks',
    description: 'Instant verification for seamless identity validation.',
  },
  {
    badge: <GlobeIcon className="w-4 h-4" />,
    title: 'Nationwide Coverage',
    description: 'Covers voter ID verification across the country.',
  },
]
