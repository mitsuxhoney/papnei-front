...
const features = [
  {
    ...
    title: 'Passport OCR',
    description: 'Extract text from passport with high accuracy.',
  },
  {
    badge: <BarChartIcon className="w-4 h-4" />,
    title: 'AI-Powered Recognition',
    description: 'Uses AI for enhanced text extraction.',
  },
  {
    badge: <DatabaseIcon className="w-4 h-4" />,
    title: 'Secure Data Storage',
    description: 'Stores extracted data with encryption.',
  },
]
