...
const features = [
  {
    ...
    description: 'Verify Aadhaar details with high accuracy.',
  },
  {
    badge: <ShieldCheckIcon className="w-4 h-4" />,
    title: 'Privacy Focused',
    description: 'Protect user data with advanced encryption.',
  },
  {
    badge: <DatabaseIcon className="w-4 h-4" />,
    title: 'Reliable Database',
    description: 'Fetch Aadhaar details from a secure and verified database.',
  },
]
