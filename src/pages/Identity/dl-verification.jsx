...
const features = [
  {
    badge: <CarIcon className="w-4 h-4" />,
    title: 'Instant DL Validation',
    description: 'Quick and accurate driving license verification.',
  },
  {
    badge: <ShieldCheckIcon className="w-4 h-4" />,
    title: 'Secure Processing',
    description: 'Ensuring compliance and security in verification.',
  },
  {
    badge: <ClockIcon className="w-4 h-4" />,
    title: '24/7 Access',
    description: 'Verify driving licenses anytime, anywhere.',
  },
]
