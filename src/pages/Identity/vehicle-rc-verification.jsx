...
const features = [
  {
    badge: <TruckIcon className="w-4 h-4" />,
    title: 'Vehicle RC Verification',
    description: 'Verify vehicle registration details securely.',
  },
  {
    badge: <ShieldCheckIcon className="w-4 h-4" />,
    title: 'Government Database Integration',
    description: 'Fetch accurate details directly from records.',
  },
  {
    badge: <CheckIcon className="w-4 h-4" />,
    title: 'Instant RC Validation',
    description: 'Verify vehicle ownership within seconds.',
  },
]
